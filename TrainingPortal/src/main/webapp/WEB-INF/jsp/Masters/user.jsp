...
<spring:url var="formAction" value="/user" ></spring:url>

<body>
    <!-- This is the main body of screen where User form is displayed - Start -->
     <div class="form_settings">
     <form:form name='userForm' id='userForm' commandName="userDto" enctype="multipart/form-data" action="${formAction}" method="post">
     <fieldset>
