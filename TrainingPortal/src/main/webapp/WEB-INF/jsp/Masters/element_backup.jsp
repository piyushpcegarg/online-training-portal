    ...
    <!-- This is the main body of screen where Element form is displayed - Start -->
     ...
     <fieldset>
  		<legend><b><spring:message code="element" /><spring:message code="form" /></b></legend>
            ...
            <p><span><spring:message code="element" /><spring:message code="engName" /></span><form:input type="text" name="engElementName" id="engElementName" path="engElementName" maxlength="200" onblur="languageConversion(engElementName , hinElementName)" onkeypress="return onlyAlphabets(event)" /></p>
            <p><span><spring:message code="element" /><spring:message code="hinName" /></span><form:input type="text" name="hinElementName" id="hinElementName" path="hinElementName" maxlength="200" />
            	<img id="hindiImage" src="resources/images/help.png" alt="help" height="15px" width="15px" onclick="getHelpImageFile();"/>
            </p>
            <p><span><spring:message code="element" /><spring:message code="engDesc" /></span><form:input type="text" name="engElementDesc" id="engElementDesc" path="engElementDesc" maxlength="200"  onblur="languageConversion(engElementDesc , hinElementDesc)" onkeypress="return onlyAlphabets(event)" /></p>
            <p><span><spring:message code="element" /><spring:message code="hinDesc" /></span><form:input type="text" name="hinElementDesc" id="hinElementDesc" path="hinElementDesc" maxlength="200" />
            	<img id="hindiImage" src="resources/images/help.png" alt="help" height="15px" width="15px" onclick="getHelpImageFile();"/>
            </p>
            <p><span><spring:message code="element" /><spring:message code="engToolTip" /></span><form:input type="text" name="engElementToolTip" id="engElementToolTip" path="engElementToolTip" maxlength="200"  onblur="languageConversion(engElementToolTip , hinElementToolTip)" onkeypress="return onlyAlphabets(event)" /></p>
            <p><span><spring:message code="element" /><spring:message code="hinToolTip" /></span><form:input type="text" name="hinElementToolTip" id="hinElementToolTip" path="hinElementToolTip" maxlength="200" />
            	<img id="hindiImage" src="resources/images/help.png" alt="help" height="15px" width="15px" onclick="getHelpImageFile();"/>
            </p>
            <p><span><spring:message code="elementType" /></span>
         	...
         	<p><span><spring:message code="editable" /></span>
         	...
         	<p><span><spring:message code="elementUrl" /></span><form:input type="text" name="elementUrl" id="elementUrl" path="elementUrl" maxlength="250" /></p>
         	<p><span><spring:message code="elementOrder" /></span><form:input type="text" name="elementOrder" id="elementOrder" path="elementOrder" maxlength="4" onkeypress="return onlyNumeric(event)" /></p>
            ...
            <p><span><spring:message code="element" /><spring:message code="status" /></span>
	            <form:select name="activateFlag" id="activateFlag" path="activateFlag" >
	            	<option value="true"<c:if test="${elementDto.activateFlag == 'true'}"> selected</c:if>><spring:message code="active" /></option>
            		<option value="false"<c:if test="${elementDto.activateFlag == 'false'}"> selected</c:if>><spring:message code="inactive" /></option>
	         	</form:select>
         	</p>
         	</c:if>
