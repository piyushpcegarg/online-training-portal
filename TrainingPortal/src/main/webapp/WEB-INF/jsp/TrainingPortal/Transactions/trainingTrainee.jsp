...
<spring:url var="formAction" value="/trainee" ></spring:url>

<body>
    <!-- This is the main body of screen where Training form is displayed - Start -->
     <div class="form_settings">
     <form:form name='trainingTraineeForm' id='trainingTraineeForm' commandName="trainingDto" action="${formAction}" method="post">
     <fieldset>
  		<legend><b><spring:message code="training" /><spring:message code="form" /></b></legend>
            ...
            <p style="padding-top: 15px"><span>&nbsp;</span>
           		<c:if test="${not empty showAddTraineeButton and showAddTraineeButton == 'true'}">
           			<form:button class="submit" id="addTraineePage" name="addTraineePage" ><spring:message code="addTrainee" /></form:button>
           			<form:button class="submit" id="deleteTraineePage" name="deleteTraineePage" ><spring:message code="deleteTrainee" /></form:button>
           		</c:if>
            	<input class="submit" type="button" name="close" value="<spring:message code="close" />" onclick="getAllTrainingsForTrainees()" />
            </p>
