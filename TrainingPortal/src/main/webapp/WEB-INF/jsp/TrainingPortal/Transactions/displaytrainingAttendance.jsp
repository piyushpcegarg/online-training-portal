...
<spring:url value="/attendance" var="formAction"></spring:url>
	
	<h2><spring:message code="different" /><spring:message code="training" /></h2>
	
	<form:form name='displayTrainingAttendanceForm' id='displayTrainingAttendanceForm' action="${formAction}" method="post" commandName="trainingDto" >
     <fieldset>
  		...
  		<display:table id="training" name="trainingList"
                    requestURI="${contextPath}/attendance/allTrainings" pagesize="10"  style="width:100%;" >
            <display:column>
		...
		<form:button class="submit" id="viewTrainingAttendancePage" name="viewTrainingAttendancePage" ><spring:message code="view" /></form:button>
