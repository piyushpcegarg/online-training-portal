...
<spring:url value="/trainee" var="formAction"></spring:url>
	...
	<form:form name='displayTrainingTraineeForm' id='displayTrainingTraineeForm' action="${formAction}" method="post" commandName="trainingDto" >
     <fieldset>
  		...
  		<display:table id="training" name="trainingList"
                    requestURI="${contextPath}/trainee/allTrainings" pagesize="10"  style="width:100%;" >
            <display:column>
		...
		<form:button class="submit" id="viewTrainingTraineePage" name="viewTrainingTraineePage" ><spring:message code="view" /></form:button>
