...
<spring:url var="formAction" value="/attendance" ></spring:url>

<body>
    <!-- This is the main body of screen where Training form is displayed - Start -->
     <div class="form_settings">
     <form:form name='trainingAttendanceForm' id='trainingAttendanceForm' commandName="trainingDto" action="${formAction}" method="post">
     <fieldset>
  		<legend><b><spring:message code="training" /><spring:message code="form" /></b></legend>
            ...
            <p style="padding-top: 15px"><span>&nbsp;</span>
           		<c:if test="${not empty showTakeAttendanceButton and showTakeAttendanceButton == 'true'}">
           			<form:button class="submit" id="takeAttendance" name="takeAttendance" ><spring:message code="takeAttendance" /></form:button>
           		</c:if>
            	<input class="submit" type="button" name="close" value="<spring:message code="close" />" onclick="getAllTrainingsForAttendance()" />
            </p>
